...
import com.cherish.device.DeviceSettings.FileUtils;
import com.cherish.device.DeviceSettings.doze.DozeSettingsActivity;
import com.cherish.device.DeviceSettings.preferences.ProperSeekBarPreference;
import com.cherish.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import com.cherish.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import com.cherish.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.cherish.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
